# ---------------------------------------------------------------------------
# Script:  3_preferred_bw.r
# Purpose: Assign DATA_SOURCE_PRIORITY to the accepted BW dataset.
# Input:   cmrs2_bw_accepted.parquet
# Output:  cmrs2_bw_accepted.parquet (overwritten with priority columns)
# ---------------------------------------------------------------------------
...
accepted_file <- "cmrs2_bw_accepted.parquet"
