# Stunting Rankings — Tables and Figures (v2)

Generated: 2026-04-17 22:44
...
**Figure:** `fig1_highest_prevalence.png` (top 10)

**Key finding:** Burundi had the highest stunting prevalence at 55.3% in 2024. The top five were Burundi, Niger, Eritrea, Angola, Papua New Guinea.
...
**Figure:** `fig2_10yr_prevalence_reduction.png` (top 10)

**Key finding:** The fastest reducer was Libya with a decline of 13.9 percentage points (2014–2024). At the upper end, the pace was about 1.4 percentage points per year.
...
**Figure:** `fig5_10yr_burden_reduction.png` (top 10)

**Key finding:** India had the largest 10-year reduction in number of stunted children (12.6 million fewer, 2014–2024).
...
**Figure:** `fig6_20yr_burden_reduction.png` (top 10)

**Key finding:** India had the largest 20-year reduction (27.5 million fewer, 2004–2024).
...
**Key finding:** Of the 150.2 million stunted children globally, the top 5 burden countries accounted for 50.1% and the top 20 for 76.8%.

>>>what percentage does India alone account for?

**Points of interest:** Burden is highly concentrated; the top 20 countries represent about three quarters of the global total.

>>>Add another similar table that looks at the reduction concentration metrics for numbers. Global number went from 201.9 to 150.2 million from 2004 to 2024. How much of the reduction was India alone? the top 5 reducers? top 10/20?
---

## Fig7 — Prevalence before and after, 10-year (dot plot)

**Figure:** `fig7_before_after_prev_10yr.png`

**Key finding:** The dot plot shows the shift in prevalence from 2014 to 2024 for the top 15 improvers, visualizing both the starting point and the magnitude of change.
...
>>> Figures 7-10 should be reduced to 10 countries.

---

## Fig8 — Prevalence before and after, 20-year (dot plot)

**Figure:** `fig8_before_after_prev_20yr.png`

**Key finding:** Over 20 years (2004–2024), the top 15 improvers showed substantial prevalence shifts. The longer time window reveals larger cumulative reductions.
...
**Figure:** `fig9_before_after_burden_10yr.png`

**Key finding:** The dot plot shows the shift in number of stunted children from 2014 to 2024 for the top 15 reducers. Large-population countries dominate the largest absolute reductions.
...
**Figure:** `fig10_before_after_burden_20yr.png`

**Key finding:** Over 20 years (2004–2024), the largest burden reductions were concentrated in a small number of very populous countries.
...
Rankings universe: 162 countries.
