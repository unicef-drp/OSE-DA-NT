...
| `stunting_top20_two_pager_v7.docx` | Current two-page Word brief generated by `4_create_two_pager.r`. |

## Current Two-Pager State

- `TWO_PAGER_BRIEF_CONTENT_V6.md` is the active narrative source for the Word brief pipeline.
- `4_create_two_pager.r` is the active on-disk Word brief generator.
- V6 content adds WHO/UNICEF prevalence threshold language ("very high", "high", etc.) and compound figure labels (1a/1b, 2a/2b).
