...
layout <- list(
  ...
  section_before = 2,
  section_after = 0.5,
  key_messages_before = 2.5,
  key_messages_after = 0.5,
  callout_left = 6,
  body_after = 1,
  footnote_after = 0.25,
  source_before = 1.5,
...
fp_subtitle <- officer::fp_text(
  font.size = 9, italic = TRUE, font.family = "Arial", color = ucol$muted
)
fp_section <- officer::fp_text(
  font.size = 12, bold = TRUE, font.family = "Arial", color = ucol$dark_blue
)
fp_body <- officer::fp_text(
  font.size = 10.5, font.family = "Arial", color = ucol$body
)
fp_body_bold <- officer::fp_text(
  font.size = 10.5, bold = TRUE, font.family = "Arial", color = ucol$body
)
fp_callout_head <- officer::fp_text(
  font.size = 10, bold = TRUE, font.family = "Arial", color = ucol$dark_blue
)
fp_callout_body <- officer::fp_text(
  font.size = 10.25, font.family = "Arial", color = ucol$dark_blue
)
fp_source <- officer::fp_text(
  font.size = 8.5, italic = TRUE, font.family = "Arial", color = ucol$muted
)
fp_fig_caption <- officer::fp_text(
  font.size = 8, bold = TRUE, font.family = "Arial", color = ucol$dark_blue
)
fp_footnote <- officer::fp_text(
  font.size = 8.5, font.family = "Arial", color = ucol$muted
)
...
add_bullet_list <- function(doc, bullets, color = ucol$body, shaded = NULL) {
  bullet_fp <- officer::fp_text(
    font.size = 10, bold = TRUE, font.family = "Arial", color = color
  )
  bullet_body_fp <- officer::fp_text(
    font.size = 10.25, font.family = "Arial", color = color
  )
  for (txt in bullets) {
    para_opts <- list(
...
page_section <- officer::prop_section(
  ...
  page_margins = officer::page_mar(
    top = 0.62, bottom = 0.45, left = 0.55, right = 0.55,
    header = 0.35, footer = 0.25
  )
)
...
doc <- add_figure_panel(doc, page1_panel, width_in = 5.55)
...
if (length(progress_figs) > 0) {
  doc <- add_figure_panel(doc, page2_panel, width_in = 5.55)
